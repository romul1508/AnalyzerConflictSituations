...
/**
 * @brief Setting default values for structure parameters of category 011 Asterix
 * @param cat - pointer to category structure
 * @return 0 - successful execution, -1 execution failure
 */
...
TCommonObmenData* pack011defaultSPdata(TSpData* sp)
{
	...
	// по умолчанию всегда выдается признак ОГП
	{
		...
		case IFR_OWN: b |= 0x01;
			break;
		case IFR_OWN_GUARANTEED:  b |= 0x02;
			break;
		case IFR_OWN_INDIVIDUAL:  b |= 0x04;
			break;
		case IFR_ALIEN: b |= 0x08;
			break;
		}
