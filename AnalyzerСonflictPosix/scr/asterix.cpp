...
char*
Asterix::make_byte_stuff(const char* at, const char* end, size_t* size)
{
...
{
	decoders[10] = Cat10::Cat10::decode;
	decoders[11] = Cat11::Cat11::decode;
	decoders[19] = Cat19::Cat19::decode;
	decoders[20] = Cat20::Cat20::decode;
	if (old_cat21)
		decoders[21] = Cat21::Ver026::Cat21::decode;
	else
		decoders[21] = Cat21::Cat21::decode;
	decoders[23]  = Cat23::Cat23::decode;
//	decoders[62]  = Cat62::Cat62::decode;
	decoders[240] = Cat240::Cat240::decode;
}

void AsterixCoder::init()
{
	coders[10]  = Cat10::Cat10::code;
	coders[11]  = Cat11::Cat11::code;
	coders[19]  = Cat19::Cat19::code;
	coders[20]  = Cat20::Cat20::code;
	coders[21]  = Cat21::Cat21::code;
	coders[23]  = Cat23::Cat23::code;
//	coders[62]  = Cat62::Cat62::code;
	coders[240] = Cat240::Cat240::code;
}
...
{ // for Linux
	...
	//	// static const uint8_t STUFF_SIZE = 2; // Linux
	//	delimit = true;
	//case A_CODE_SINGLE: {
	//	char*   data;
	//	size_t  size;
