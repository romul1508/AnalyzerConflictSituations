...
#include "asterix_data_lib.h"
#include "cat_asterix.h"
#include "Util.h"

/**
 * @brief Data storage structure for unpacking / packing in interchange libraries
 */
...
/**
 * @brief Translation from the IA5 alphabet to the ASCII alphabet
 * @param dest - pointer to array of stacking conversion result
 * @param ist - pointer to array with original data
 * @param cnt - starting byte number of the original record
 * @return - 0 - successful execution, -1 failure of the operation
 */
