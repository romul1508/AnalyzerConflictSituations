#ifndef ASTERIX_CAT_11_HPP
#define ASTERIX_CAT_11_HPP
	...
	public AsterixRecord
{
	...
	struct Uap
	{
		...
		struct Serializer;
		void (Serializer::* serialize)(Cat11&);                     ///< Функция-обработчик
	};
	...
	ASTERIX_DECLARE(DataSourceId,      Cat11,  1, _dsi);                ///< Data Source Identifier
